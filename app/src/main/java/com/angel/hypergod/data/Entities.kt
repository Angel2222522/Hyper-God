...
object CaseStatus {
    const val NEW = "Πρόχειρη"
    const val IN_PROGRESS = "Ετοιμάζεται"
    const val SUBMITTED = "Κατατέθηκε"
    const val WAITING = "Αναμονή απάντησης"
    const val ACTION = "Χρειάζεται ενέργεια"
    const val APPROVED = "Εγκρίθηκε"
    const val REJECTED = "Απορρίφθηκε"
