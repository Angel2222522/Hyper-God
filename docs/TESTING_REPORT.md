...
Test suites cover metadata extraction/ownership, FTS repair, import typing, reminder dates, storage coordination, cleanup, duplicate identity, relationship hints, grounded answers, profile discrepancies, Room migrations, encrypted backup round trips, corrupt/wrong-password restore, repository import/delete/export, PDF rendering/original preservation, OCR fixtures, pending encrypted activity state, and Greek navigation smoke paths.
